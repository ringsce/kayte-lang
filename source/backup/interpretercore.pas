...
uses
  ...
  fgl,               // <--- ADDED THIS LINE FOR TFPGMap
...
// Assuming SetVar and GetVar are defined globally or in InterpreterUtils
procedure SetVar(const name: String; val: TVariable); forward;
function GetVar(const name: String): TVariable; forward;
...
// Implementations of SetVar and GetVar (copied from your .lpr for self-containment)
