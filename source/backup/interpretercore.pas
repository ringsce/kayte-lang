...
begin
  ...
  begin
    ...
    begin
      // If no object is assigned, it means the variable was declared but not initialized.
  ...
  begin
    // Variable not found at all, return a default/empty variable
    Result.vtype := vtInteger; // Default to integer
    Result.intValue := 0;
    Result.strValue := '';
    // Optionally, you could raise an error here for using an undeclared variable.
  end;
end;
