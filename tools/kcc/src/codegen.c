...
void codegen_function_declaration(CodeGenerator *codegen, ASTNode *node) {
    ...
    // fallback epilogue, in case the function body has no explicit return
...
void codegen_variable_declaration(CodeGenerator *codegen, ASTNode *node) {
    ...
    if (node->data.var_decl.initializer) {
        ...
        // doesn't actually track stack slots yet, just a placeholder marker
...
void codegen_call_expression(CodeGenerator *codegen, ASTNode *node) {
    ...
    // pushed right-to-left to match the cdecl calling convention
...
void codegen_identifier(CodeGenerator *codegen, ASTNode *node) {
    ...
    // doesn't do real stack allocation yet — every identifier reads the same slot
